...
import by.epam.pretraining.chertok.tasks.task9.model.textConverters.FileNotOpenedException;
...
public class Test {
    ...
    public static void main(String[] args) throws FileNotOpenedException {
        ...
        View.print("------------------------------------");
        View.print(TEXT_MAKER.makeString(LETTERS_REMOVER.removeAllFirstLetters(TEXT_SEPARATOR.splitToWords(TEXT_READER.readText(PATH)))));
        View.print("------------------------------------");
